...
int main(int argc,char** argv)
{
	...
	for(int i=1;i<argc;i++)
	{
		...
		TH1F* _histo1 = (TH1F*) _file0->Get("h1DiffRelEvQCalib");
		TH1F* _histo0 = (TH1F*) _file0->Get("h1DiffRelEvQ");
		_histo0->SetLineColor(3);
